export function createApiRouter(handlers) {
  const routes = [
    ...
    route('GET', '/api/selected-tags', handlers.getSelectedTags),
    route('PUT', '/api/selected-tags', handlers.updateSelectedTags),
    route('GET', '/api/selected-tag-stats', handlers.getSelectedTagStats),
    route('GET', '/api/selected-chart-tags', handlers.getSelectedChartTags),
    route('PUT', '/api/selected-chart-tags', handlers.updateSelectedChartTags),
    route('GET', '/api/selected-chart-tag-stats', handlers.getSelectedChartTagStats),
    ...
    route('GET', /^\/api\/applications\/\d+\/process-steps$/, handlers.getProcessSteps, pathId),
    route('POST', /^\/api\/applications\/\d+\/process-steps$/, handlers.createProcessStep, pathId),
    route('PUT', /^\/api\/applications\/\d+\/process-steps\/order$/, handlers.reorderProcessSteps, pathId),
    ...
    route('GET', '/api/process-steps/upcoming', handlers.getUpcomingProcessSteps),
    route('GET', '/api/process-steps/summaries', handlers.getProcessStepSummaries),
    route('GET', '/api/process-insights', handlers.getProcessInsights),
    route('PUT', /^\/api\/process-steps\/\d+$/, handlers.updateProcessStep, pathId),
    route('DELETE', /^\/api\/process-steps\/\d+$/, handlers.deleteProcessStep, pathId),
